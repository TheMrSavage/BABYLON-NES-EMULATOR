# TODO
Just a list of stuff to do in code to make things simpler and more organized
...
- [] Put `AddressSanitizer` and `UndefinedBehaviorSanitizer` flags in `CMake` workflow
